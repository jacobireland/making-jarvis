...
4. Speak, then **pause** (Flux auto-sends). After the spoken reply, listening **comes back on**. The status bar shows **LISTENING** or **IDLE** — click it to **turn listening off**, or **send now**.
